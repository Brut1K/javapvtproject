package by.it_academy.lesson17.part3;
  ...
  /*      for(String s:args){
    ...
    public static void parseXML(){
        try {
            ...
            StreamResult result = new StreamResult(new File("D:\\javapvt\\javapvtproject\\src\\by\\it_academy\\lesson17\\part3\\result_task2.xml"));
